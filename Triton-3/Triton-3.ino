/**
 * @file Triton-3.ino
 * @brief Triton-3 Osezaki Camp 2026 firmware using the protocol_v36 TWELITE wireless protocol.
 *
 ...
 *
 * v4 keeps the Triton-3-v2 hardware integration for GPS, RTC, TSYS01, MS5837,
